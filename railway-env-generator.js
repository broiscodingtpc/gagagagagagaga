...
const requiredVars = [
  ...
  'MNEX_WEBSITE_URL',
  'MNEX_TOPICS',
  'MNEX_POST_INTERVAL_MIN',
  'MNEX_POST_INTERVAL_MAX',
  'MNEX_DAILY_REPORT_HOUR',
  'MNEX_MEMORY_DECAY_DAYS',
  'MNEX_IMPROVEMENT_INTERVAL_DAYS',
  'MNEX_LEARNING_PROOF_LOG',
  'MNEX_DEVELOPER_TG_ID'
];
